...
INFLUXDB_TOKEN = "PNvT7TJrSgWLFp-fxSVVUh0HBVGpcYnomRMzdXamKX4DRbgN-vNFFgQjICtyI9yAO7z98UcgyPehE-HbjrT1KQ=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "IoT"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "Lab13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "10.13.43.95"  # ESP32's MQTT broker address
